...
if __name__ == '__main__':
    ...
    for TRAINING_GRID in ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I']:
        ...
        #joblib.dump(scaler, f'Models/Final/Normalizer/{RECORDINGS}/scaler_{TRAINING_GRID}_vs_ALL.pkl')
        ...
        print('LogisticRegression for Model: ', TRAINING_GRID)
        ...
        model_filename = f"Models/Final/LogisticRegression/{RECORDINGS}/{TRAINING_GRID}_vs_ALL.pkl"
        if test100 > test80:
        ...
        # Store model
        '''model_filename = f"Models/Focused_Spectrograms/LogisticRegression/{RECORDINGS}/{TRAINING_GRID}_vs_ALL.pkl"
        joblib.dump(final_model, model_filename)'''
        # TODO Store train model
        joblib.dump(model, f"Models/Final/LogisticRegression/{RECORDINGS}/train_{TRAINING_GRID}_vs_ALL.pkl")


    '''csv_filename = f'Results/Training/Focused_Spectrograms/LogisticRegression/{RECORDINGS}.csv'
    # Open the CSV file in write mode
    with open(csv_filename, 'w', newline='') as csv_file:
        # Create a CSV writer
        csv_writer = csv.writer(csv_file)

        # Write the data to the CSV file as a single row
